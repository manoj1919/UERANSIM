...
**This fork is for learning and experimentaion with UERANSIM. So please donot use it , it might be full of bugs and issues. Use original [UERANSIM] (https://github.com/aligungr/UERANSIM/)**
